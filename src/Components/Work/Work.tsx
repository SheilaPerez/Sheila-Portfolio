    ...
    return (
        <div id="work" className="workContent">
            ...
            <div className="works">
                ...
                <Project handleClickOpenProject={openProjects} projectName={"nba"} descriptionProject={"Consult the teams and see the files of your favorite players"} techsDescription={"React, CSS3, typescript"} projectStyle={"nba"} handleClickGitDireccion={gitDireccion}></Project>
            </div>
        </div>
    )
};
